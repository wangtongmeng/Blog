...
递归组件要领，那一块重复使用，就拆成一个组件

## **17. Vue技术栈开发实战-可编辑表格的实现**

1. JSX进阶
2. **iview表格**实现单个单元格编辑表格
3. **iview表格**实现多单元格编辑表格

## 18. **Vue技术栈开发实战-Tree组件实现文件目录-基础实现**

1. **iview - Tree**实现Tree组件使用
2. 扁平数据树状化
3. 自定义组件结构

获取文件夹和文件列表的扁平化数据

把文件放到文件夹中，再把文件夹按照层级关系拼成树状结构。
